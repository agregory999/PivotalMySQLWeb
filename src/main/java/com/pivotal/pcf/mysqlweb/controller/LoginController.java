...
public class LoginController {
	...
	public String login(Model model, HttpSession session) throws Exception {
		...
		// Can't be null and has to be more than {}
		if (jsonString != null && jsonString.length() > 3) {
			try {
				...
				log.info("** Login URL: " + login.getUrl());
				log.info("** Login User: " + login.getUsername().toUpperCase());
				...
				log.info("Auto Login via VCAP_SERVICES Failed - " + ex);
			}
